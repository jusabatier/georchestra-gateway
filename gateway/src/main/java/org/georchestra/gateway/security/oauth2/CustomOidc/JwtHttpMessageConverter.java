...
/**
 * Message converter for reading JWTs transmitted with content type
...
public class JwtHttpMessageConverter extends AbstractGenericHttpMessageConverter<String> {
    ...
    @Override
    protected void writeInternal(String stringObjectMap, Type type, HttpOutputMessage outputMessage)
